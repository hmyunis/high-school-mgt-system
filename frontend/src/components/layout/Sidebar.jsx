...
const sidebarConfig = {
  ...
  TEACHER: [
    { label: 'Dashboard', icon: <Home className="size-5" />, to: '/dashboard/teacher' },
    { label: 'My Courses', icon: <BookOpen className="size-5" />, to: '/dashboard/my-courses' },
    // { label: 'Assessments', icon: <ClipboardList className="size-5" />, to: '/dashboard/assessments' },
    { label: 'Students', icon: <Users className="size-5" />, to: '/dashboard/students' },
    { label: 'My Profile', icon: <GraduationCap className="size-5" />, to: '/dashboard/profile' },
    { label: 'Logout', icon: <LogOut className="size-5" />, to: '/logout' },
  ],
  STUDENT: [
    { label: 'Dashboard', icon: <Home className="size-5" />, to: '/dashboard/student' },
    { label: 'My Courses', icon: <BookOpen className="size-5" />, to: '/dashboard/mycourses' },
    // { label: 'My Grades', icon: <FileText className="size-5" />, to: '/dashboard/grades' },
    // { label: 'My Attendance', icon: <ClipboardList className="size-5" />, to: '/dashboard/attendance' },
    { label: 'My Profile', icon: <GraduationCap className="size-5" />, to: '/dashboard/profile' },
    { label: 'Logout', icon: <LogOut className="size-5" />, to: '/logout' },
  ],
};
